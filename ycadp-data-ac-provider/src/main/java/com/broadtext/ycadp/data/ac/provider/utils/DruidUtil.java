...
public class DruidUtil {
    ...
    public DruidUtil(TBDatasourceConfig tbDatasourceConfig) {
        String decrypt = "";
...
//        String decrypt = AesUtil.decrypt(tbDatasourceConfig.getDatasourcePasswd(), "broadtext");
        ...
        datasourceInner.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        datasourceInner.setUrl("jdbc:sqlserver://" + tbDatasourceConfig.getConnectionIp() + ":" + tbDatasourceConfig.getConnectionPort() + ";"
                        + " DatabaseName=" + tbDatasourceConfig.getSchemaDesc() + ";");//url
     ...
     * 声明连接池线程共享变量
     */
    private static ThreadLocal<DruidDataSource> dsContainer = new ThreadLocal<>();
